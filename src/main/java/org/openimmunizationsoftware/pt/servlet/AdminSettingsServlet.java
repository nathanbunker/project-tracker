                ...
                try {
                        ...
                        if (action != null) {
                                if (action.equals(ACTION_SAVE_ADMIN)) {
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_REPORT_DAILY_ENABLED,
                                                        request.getParameter(PARAM_REPORT_DAILY_ENABLED) != null ? "Y"
                                                                        : "N",
                                                        dataSession);
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_REPORT_DAILY_TIME,
                                                        request.getParameter(PARAM_REPORT_DAILY_TIME), dataSession);
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EXTERNAL_URL,
                                        ...
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        ...
                                                        dataSession);
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_DEBUG,
                                                        request.getParameter(PARAM_EMAIL_DEBUG) != null ? "Y" : "N",
                                                        dataSession);
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_USE_SMTPS,
                                                        request.getParameter(PARAM_USE_SMTPS) != null ? "Y" : "N",
                                                        dataSession);
                                        TrackerKeysManager.saveApplicationKeyValue(
                                        ...
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_SMTPS_PORT,
                                                        request.getParameter(PARAM_EMAIL_SMTPS_PORT), dataSession);
                                        TrackerKeysManager.saveApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_REPLY,
                                                        request.getParameter(PARAM_EMAIL_REPLY), dataSession);

                                        if (request.getParameter(PARAM_SEND_TEST_EMAIL) != null) {
                                                String testEmailTo = trim(request.getParameter(PARAM_TEST_EMAIL_TO),
                                                                254);
                                                if (testEmailTo.equals("")) {
                                                        testEmailTo = trim(request.getParameter(PARAM_EMAIL_REPLY),
                                                                        254);
                                                }
                                                if (testEmailTo.equals("")) {
                                                        testEmailTo = trim(
                                                                        request.getParameter(
                                                                                        PARAM_EMAIL_SMTPS_USERNAME),
                                                                        254);
                                                }
                                                ...
                                                if (testEmailTo.equals("")) {
                                                        ...
                                                        try {
                                                                ...
                                                                body.append("<p>Time: ").append(new Date())
                                                                                .append("</p>");
                                                                body.append("</body></html>");
                                                                mailManager.sendEmail("Dandelion Test Email",
                                                                                body.toString(), testEmailTo);
                                                                appReq.setMessageConfirmation("Test email sent to "
                                                                                + testEmailTo + ".");
                                                        } catch (Exception e) {
                                                                appReq.setMessageProblem("Unable to send test email: "
                                                                                + e.getMessage());
                                                        }
                                                }
                                        }
                                        ...
                                        for (ProjectCategory projectCategory : projectCategoryList) {
                                                ...
                                                String clientAcronym = request
                                                                .getParameter(PARAM_CLIENT_ACRONYM_PREFIX + c);
                        ...
                        for (ProjectCategory projectCategory : projectCategoryList) {
                                ...
                                out.println("     <td><input type=\"text\" size=\"30\" name=\""
                                                + PARAM_CLIENT_NAME_PREFIX + c + "\" value=\""
                                                + projectCategory.getClientName()
                                                + "\"></td>");
                                out.println("     <td><input type=\"text\" size=\"3\" name=\""
                                                + PARAM_SORT_ORDER_PREFIX + c + "\" value=\""
                                                + n(projectCategory.getSortOrder())
                                                + "\"></td>");
                                ...
                                out.println("     <td><input type=\"checkbox\" name=\"" + PARAM_VISIBLE_PREFIX + c
                                                ...
                                                + (projectCategory.getVisible() != null
                                                                && projectCategory.getVisible().equals("Y")
                                                                                ? " checked=\"true\""
                                                                                : "")
                                                + "></td>");
                                out.println("  </tr>");
                        ...
                        out.println("      <input type=\"checkBox\" name=\"" + PARAM_EMAIL_ENABLE
                                        + "\" value=\"Y\"" + (n(TrackerKeysManager.getApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_ENABLE, dataSession))
                                                        .equals("Y")
                                                                        ? " checked"
                                                                        : "")
                                        + ">");
                        ...
                        out.println("      <input type=\"checkBox\" name=\"" + PARAM_EMAIL_DEBUG
                                        + "\" value=\"Y\"" + (n(TrackerKeysManager.getApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_DEBUG, dataSession))
                                                        .equals("Y")
                                                                        ? " checked"
                                                                        : "")
                                        + ">");
                        ...
                        out.println("      <input type=\"checkBox\" name=\"" + PARAM_USE_SMTPS
                                        + "\" value=\"Y\"" + (n(TrackerKeysManager.getApplicationKeyValue(
                                                        TrackerKeysManager.KEY_SYSTEM_EMAIL_USE_SMTPS, dataSession))
                                                        .equals("Y")
                                                                        ? " checked"
                                                                        : "")
                                        + ">");
                        ...
                        out.println("    <td class=\"boxed\">");
                        out.println("      <input type=\"checkbox\" name=\"" + PARAM_SEND_TEST_EMAIL
                                        + "\" value=\"Y\"> ");
                        out.println("      To: <input type=\"text\" name=\"" + PARAM_TEST_EMAIL_TO
                                        + "\" size=\"40\" value=\"\"> ");
                        out.println("      <span class=\"small\">(optional: defaults to reply address, then SMTP username)</span>");
                        out.println("    </td>");
                        out.println("  </tr>");
                        out.println("  <tr class=\"boxed\">");
                        out.println("    <th class=\"boxed\">Daily Reports Enabled</th>");
                        out.println("    <td class=\"boxed\">");
                        out.println("      <input type=\"checkBox\" name=\"" + PARAM_REPORT_DAILY_ENABLED
                                        + "\" value=\"Y\"" + (n(TrackerKeysManager.getApplicationKeyValue(
                                                        TrackerKeysManager.KEY_REPORT_DAILY_ENABLED, dataSession))
                                                        .equals("Y")
                                                                        ? " checked"
                                                                        : "")
                                        + ">");
                        ...
                        for (String username : ClientServlet.webUserLastUsedDate.keySet()) {
                                ...
                                out.println("    <td class=\"boxed\">"
                                                + sdf.format(ClientServlet.webUserLastUsedDate.get(username))
                                                + "</td>");
                                out.println("  </tr>");
                        }
                        out.println("</table>");
