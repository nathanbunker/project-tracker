          ...
          if (webUserList.size() > 0) {
            ...
            if (childWebUserList.size() > 0) {
              for (WebUser childWebUser : childWebUserList) {
                projectContact = (ProjectContact) dataSession.get(ProjectContact.class,
                    childWebUser.getContactId());
            ...
            message =
                "Welcome " + projectContact.getNameFirst() + " " + projectContact.getNameLast();
