...
public class CssServlet extends ClientServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp)
                ...
                out.println("}");
                out.println("p {");
                out.println("  color:#2B3E42; ");
                out.println("  font-size: 14px; ");
                out.println("  line-height: 1.5; ");
                out.println("  margin: 8px 0; ");
                out.println("}");
                out.println("h3, h4 {");
                out.println("  color: #1A2A2E; ");
                out.println("  font-weight: bold; ");
                out.println("  line-height: 1.3; ");
                out.println("}");
                out.println("h3 {");
                out.println("  font-size: 18px; ");
                out.println("  margin: 12px 0 6px; ");
                out.println("  overflow: hidden; ");
                out.println("}");
                out.println("h4 {");
                out.println("  font-size: 14px; ");
                out.println("  margin: 10px 0 4px; ");
                out.println("}");
                out.println("ul {");
                ...
                out.println("}");
                out.println("a.edit-link {");
                out.println("  font-size: 12px; ");
                out.println("  color: #6C757D; ");
                out.println("  text-decoration: none; ");
                out.println("  padding: 2px 4px;  ");
                out.println("  border-radius: 3px; ");
                out.println("  transition: background-color 0.2s, color 0.2s;  ");
                out.println("}");
                out.println("a.edit-link:hover {");
                out.println("  background-color: #FFFF99; ");
                out.println("  color: #2B3E42; ");
                out.println("  text-decoration: none; ");
                out.println("}");
                ...
                out.println("    padding: 10px; /* Adjust for your preference */");
                out.println("    box-sizing: border-box;");
                out.println("}");
                out.println("");
                out.println("/* Specific width for each column */");
                out.println("#actionNow{");
                ...
                out.println(
                                "th.title {background-color: " + backgroundColor
