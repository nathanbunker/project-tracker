...
public class BillCodeServlet extends ClientServlet
{
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      out.println("  <tr>");
      out.println("    <th class=\"title\" colspan=\"2\"><span class=\"right\"><font size=\"-1\"><a href=\"BillCodeEditServlet?billCode="
      ...
      out.println("    <td class=\"boxed\">" + (billCode.getBillable() != null && billCode.getBillable().equals("Y") ? "Yes" : "No") + "</td>");
      out.println("  </tr>");
      out.println("  <tr class=\"boxed\">");
      out.println("    <th class=\"boxed\">Visible</th>");
      out.println("    <td class=\"boxed\">" + (billCode.getVisible() != null && billCode.getVisible().equals("Y") ? "Yes" : "No") + "</td>");
      out.println("  </tr>");
      out.println("  <tr class=\"boxed\">");
      out.println("    <th class=\"boxed\">Estimate Min</th>");
      out.println("    <td class=\"boxed\">" + TimeTracker.formatTime(billCode.getEstimateMin()) + "</td>");
      out.println("  </tr>");
      out.println("  <tr class=\"boxed\">");
      ...
      if (billCode.getBillCode() != null && !billCode.getBillCode().equals(""))
      {
        ...
        for (BillBudget billBudget : billBudgetList)
        {
          out.println("<table class=\"boxed\">");
          out.println("  <tr>");
          out.println("    <th class=\"title\" colspan=\"3\">Budget for " + billBudget.getBillBudgetCode() + "</th>");
          out.println("  </tr>");
          out.println("  <tr class=\"boxed\">");
          out.println("    <th class=\"boxed\">Budget Code</th>");
          out.println("    <td class=\"boxed\" colspan=\"2\">" + n(billBudget.getBillBudgetCode()) + "</td>");
          out.println("  </tr>");
          out.println("  <tr class=\"boxed\">");
          out.println("    <th class=\"boxed\">Start Date</th>");
          out.println("    <td class=\"boxed\" colspan=\"2\">" + (billBudget.getStartDate() == null ? "" : sdf.format(billBudget.getStartDate())) + "</td>");
          out.println("  </tr>");
          out.println("  <tr class=\"boxed\">");
          out.println("    <th class=\"boxed\">End Date</th>");
          out.println("    <td class=\"boxed\" colspan=\"2\">" + (billBudget.getEndDate() == null ? "" : sdf.format(billBudget.getEndDate())) + "</td>");
          out.println("  </tr>");
          out.println("  <tr class=\"boxed\">");
          out.println("    <th class=\"boxed\">Bill Hours</th>");
          out.println("    <td class=\"boxed\" colspan=\"2\">" + TimeTracker.formatTime(billBudget.getBillMins()) + "</td>");
          out.println("  </tr>");
          ...
          out.println("</table> ");
          out.println("<p><a href=\"BillBudgetServlet?billBudgetId=" + billBudget.getBillBudgetId() + "\">Bill Budget Report</a></p>");
        }
      }
      printHtmlFoot(out);
