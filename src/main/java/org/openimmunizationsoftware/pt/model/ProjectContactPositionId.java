...
public class ProjectContactPositionId implements java.io.Serializable {
  ...
  public boolean equals(Object other) {
    ...
    return (this.getContactId() == castOther.getContactId())
        && ((this.getPositionDate() == castOther.getPositionDate())
            || (this.getPositionDate() != null && castOther.getPositionDate() != null
                && this.getPositionDate().equals(castOther.getPositionDate())));
  }
