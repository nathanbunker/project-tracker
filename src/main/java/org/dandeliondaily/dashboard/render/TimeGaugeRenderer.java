...
public class TimeGaugeRenderer {
    ...
    public void printStyles(PrintWriter out) {
        ...
        out.println("  }");
        out.println("  .dd-time-gauge-row.dd-state-warning .dd-time-gauge-bar {");
        out.println("    background: #c78b34;");
        out.println("  }");
        ...
        out.println("  }");
        out.println("  .dd-time-gauge-row.dd-state-over .dd-time-gauge-bar {");
        out.println("    background: #b24a4a;");
        out.println("  }");
        ...
        out.println("  }");
        out.println("  .dd-time-gauge-row.dd-state-unknown .dd-time-gauge-bar {");
        out.println("    background: #92a59b;");
        out.println("  }");
